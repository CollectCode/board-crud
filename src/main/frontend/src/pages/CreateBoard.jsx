...
const CreateBoard = () => {
    ...
    return  (
        <>
            <label>제목</label><br/>
            <input id='input_title' type='text' placeholder="제목을 입력하세요" onChange={(e) => setTitle(e.target.value)} value={title} /><br/><br/>
            <label>내용</label><br/>
            <textarea id="textarea_content" type="text" placeholder="내용을 입력하세요" onChange={(e) => setContent(e.target.value) } value = {content} /><br/>
            <input type="button" value="게시물 생성" onClick={handleInputClick}/>
        </>
    )    
}
